  ...
  return (
    ...
    <Container component="main" maxWidth="l">
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        <DialogTitle id="form-dialog-title">Select Approve or Reject</DialogTitle>
        <DialogContent>
      ...
      <div style={{ display: 'flex', height: 500, width: '100%' }}>
        <DataGrid
          columns={[
            ...
            { field: 'startDate', headerAlign: 'center', headerName: 'Start Date', width: 180 },
            { field: 'endDate', headerName: 'End Date', headerAlign: 'center', width: 180 },
            {
            ...
            { field: 'expense', headerName: 'Expense Type', headerAlign: 'center', width: 180 },
            { field: 'project', headerName: 'Project Name', headerAlign: 'center', width: 180 },
            {
              field: 'action', headerName: 'Actions', headerAlign: 'center', width: 150,
              renderCell: (params) => (
                <>
                  <Link to="/">
                  ...
                  {params.value.split(" ")[1].toLowerCase() === 'pending' &&
                    <Tooltip title="Edit claim" arrow>
                      <IconButton aria-label="Edit" color='primary' onClick={() => handleOpenEdit(params.value.split(" ")[0])}>
                  ...
                  {params.value.split(" ")[1].toLowerCase() === 'pending' &&
                    <Tooltip title="Approve or Reject claim" arrow>
                      <IconButton aria-label="approve" className={classes.approveBtn} onClick={() => handleOpen(params.value.split(" ")[0])}>
